...
class TempCNN(nn.Module):
    def __init__(self, input_dim=10, num_classes=9, hidden_dims=128, kernel_size=7, dropout=0.2 ):
        ...
        self.dense = FC_BatchNorm_Relu_Dropout(hidden_dims * 12, 4 * hidden_dims, drop_probability=dropout)
